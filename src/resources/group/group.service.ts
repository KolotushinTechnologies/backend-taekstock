...
class GroupService {
     ...
     */
     public async getGroups(): Promise<string | object | Error> {
        try {
            ...
            const groups = await this.group.find({}).populate('branch coach students');
    ...
    public async getGroupById(
        ...
        try {
            ...
            const group = await this.group.findOne({ _id: groupId }).populate('branch coach students');
    ...
    public async findGroups(content: string): Promise<string | object | Error> {
        try {
            ...
            ]}).populate('branch coach students');
