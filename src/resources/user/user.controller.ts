...
class UserController implements Controller {
    ...
    private initializeRoutes(): void {
        ...
        // @route    POST http://localhost:8000/api/users/login
        // @desc     Login Users
        // @access   Public
        this.router.post(
            `${this.path}/login`,
        ...
        // @route    POST http://localhost:8000/api/users/forgot-password
        ...
        // @route    POST http://localhost:8000/api/users/change-password
        ...
        // @route    PUT http://localhost:8000/api/users/change-password-profile
        ...
        // @route    PUT http://localhost:8000/api/users/update-my-profile
        ...
        // @route    GET http://localhost:8000/api/users
    ...
    private forgotPassword = async (
        ...
        try {
            ...
            // User Service Work
            const serviceResponse = await this.UserService.forgotPassword(phoneNumber);
    ...
    private changePassword = async (
        ...
        try {
            // Getting data from a request
            const { phoneNumber, secretCode, newPassword } = req.body;
